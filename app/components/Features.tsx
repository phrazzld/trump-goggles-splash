  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-center font-display text-5xl text-retro-blue mb-12 text-shadow-vintage">
          Features
        </h2>
            ...
            return (
              <TexturedCard key={index}>
                <div className="p-8 text-center">
                  ...
                  <h3 className="font-display text-2xl text-retro-blue mb-3 text-shadow-vintage">
                    {feature.title}
                  </h3>
                  <p className="font-body text-retro-black">
                    {feature.description}
                  </p>
                </div>
              </TexturedCard>
